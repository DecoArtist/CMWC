const web_content = `{
    "1":{
        ...
        "menu_music":"cmw_/War_Map_Ambience.mp3",
...
function NavSizeGenerator(x) {
    if (x.matches) {
        ...
        <div class="navigation-menu__mobile ${cmwc[(1)].WebGame_theme1}" style="display: none;">
            ...
            <img src="cmw_/Monk_Mini.png" alt="mobile-menu render" class="mobile-menu__render">
        </div>`,
...
<div class="container p-absolute page-credits__Minis">
    <img src="cmw_/ArcherQueen_Mini.png">
    <img src="cmw_/Barbarian_King_Mini.png">
</div>`