const web_content = `{
    "1":{
        ...
        "menu_music":"cmw_/War_Map_Ambience.rvr6jg16.mp3",
...
root.style.setProperty('--header_banner', 'url(../skygradient_regular.jgzk7vj0.jpg)');
...
function NavSizeGenerator(x) {
    if (x.matches) {
        ...
        <div class="navigation-menu__mobile ${cmwc[(1)].WebGame_theme1}" style="display: none;">
            ...
            <img src="cmw_/Monk_Mini.57do9x9q.png" alt="mobile-menu render" class="mobile-menu__render">
        </div>`,
  ...
  NavSizeGenerator(mmObj);
  
  mmObj.addListener(NavSizeGenerator);
...
<div class="container p-absolute page-credits__Minis">
    <img src="cmw_/ArcherQueen_Mini.nzemsfa7.png">
    <img src="cmw_/Barbarian_King_Mini.i30tvvjn.png">
</div>`